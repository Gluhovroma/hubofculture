    ...
    .directive("anguvideo", function ($sce) {
        return {
            ...
            template: '<div class="anguvideo">' +
                            '<iframe class="videoClass" type="text/html" width="{{width}}" height="{{height}}" ng-src="{{url}}" allowfullscreen webkitallowfullscreen mozallowfullscreen frameborder="0" ></iframe>' +
                      '</div>',
            link: function (scope) {
                    ...
                    if (newVal) {
                        ...
                        */
                        ...
                        if (newVal.indexOf("vimeo") >= 0) { // Displaying a vimeo video
                            ...
                            embedFriendlyUrl = embedFriendlyUrl + '?wmode=opaque';
                            ...
                            if (newVal.indexOf("embed") >= 0) {
                                ...
                                embedFriendlyUrl = embedFriendlyUrl + '?rel=0&wmode=opaque&amp';
                            }
                        }
