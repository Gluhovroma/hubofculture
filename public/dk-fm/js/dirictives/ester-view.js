(function () {
    ...
    angular.module('dk-fm.controllers.directives.ester-view', [])
        ...
        .directive('esterView', function ($compile, $rootScope,$state) {         
            ...
            return {
                ...
                link: function (scope, elt) {    
                    ...
                    scope.readPost = function(url) {
                        $state.go('articles.article', {'name':url})
                    }
                    scope.likePost = function(post) {
                        console.log(post);
                    }
                    scope.goHash = function(tag) {
                        $state.go('articles', {'tag': tag})
                    }
            ...
            $rootScope.youtubeVideo = id;
                ...
                $rootScope.youtubeVideo = id;
                        ...
                        strVar += "      <\/p>";
                        strVar += "    <\/div>      ";
                        strVar += "    <div style=\"padding: 0;\" class=\"col-md-6\">";
                        ...
                        strVar += "         <\/div>";
                        strVar += "    <\/div>";
                        strVar += "    <div class=\"col-md-6\" style=\"padding:0px 15px 0px 15px\">";
                        ...
                        strVar += "          <a href=\"\" ng-click=\"goHash(tag.urlname)\" class=\"tag\" title=\"Yeah Yeah Yeahs  \" ng-repeat=\"tag in ::simple.tags\">";
                        strVar += "      ";
                        ...
                        strVar += "        <div class=\"cover\">";
                        strVar += "        <a href=\"\" ng-click=\"readPost(multiplepost.urlname)\">";
                        ...
                        strVar += "      <a href=\"\" ng-click=\"readPost(multiplepost.urlname)\" class=\"title black\" ng-bind=\"::multiplepost.title\" style=\"color: #333;font-size: 20px;\"><\/a>";
                        strVar += "    <\/h3>  ";
                        strVar += "    <div class=\"frontside\">";
                        strVar += "      <div class=\"grid_tags tags\">";
                        strVar += "        <a href=\"\" ng-click=\"goHash(tag.urlname)\" class=\"tag\" title=\"Yeah Yeah Yeahs  \" ng-repeat=\"tag in ::multiplepost.tags\">       ";
                        strVar += "            <span  ng-bind=\"::'#'+tag.name\"><\/span>";
                        strVar += "          <\/a>";
                        strVar += "      <\/div>";
                        strVar += "    <\/div>";
                        strVar += "    <div class=\"annotation\" style=\"\" ng-bind-html=\"::multiplepost.content\"><\/div> ";
                        strVar += "    <div style=\"margin-top:10px\">";
                        strVar += "        <a href=\"\" ng-click=\"readPost(multiplepost.urlname)\" style=\"font-size: 12px;\">Читать далее...<\/a>";
                        strVar += "    <\/div>";                         

                        

                        strVar += "    <\div>";
                        strVar +=   `<i class="ion-ios-heart-outline heart-black" ng-class="like" ng-click="likePost(multiplepost)" ng-show="$root.user != null";></i>`
