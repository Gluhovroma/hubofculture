var s,
	app={
		...
		// 	var d,e;
		// 	return 
		// 	"twitter"==a?d="http://twitter.com/home?status="+encodeURI(b)+"+"+c:"facebook"==a&&(d="http://www.facebook.com/share.php?u"+c+"&amp;title="+encodeURI(b)),e=window.open(d,"name","height=500,width=600"),window.focus&&e.focus(),!1
		// },
		jpm:function(){
			s.jpm=$.jPanelMenu(
				{
					menu:"#menu-target",trigger:".menu-trigger",animated:!1,
					beforeOpen:function(){
